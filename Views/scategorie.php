            ...
            <div class="col-sm-12">
                <div class="card elevation-3">
                    <div class="card-body table-responsive">
                        ...
                        <table id="table-sous-categorie" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr>
                                    <th scope="col">ID</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h4 class="modal-title">Nouvelle sous catégorie</h4>
        ...
        <div class="modal-content">
            ...
            <div id="editForm">
                ...
                <div class="modal-body mt-3">
                    <div class="form-group">
                        <label for="code">Catégorie</label>
                        <select name="categorie_id" id="m_categorie_id" class="custom-select">
                            <option value=""></option>
                            <?php foreach($categories as $categorie): ?>
                                <option value="<?= $categorie['id'] ?>"><?= $categorie['code'].' - '.$categorie['description'] ?></option>
                            <?php endforeach; ?>
...
var controller = "./Controllers/scategorie.php";

var tableSousCategorie = $("#table-sous-categorie");

var datatable_sous_categorie = tableSousCategorie.DataTable({
    "deferRender": true,
...
$('#saveBtn').on('click', function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(data.success) {
				datatable_sous_categorie.ajax.reload(null, true);
...
$(document).on('click', '.delete-btn', function() {
	...
	var data = datatable_sous_categorie.row(row).data();
...
$(document).on('click', '.update-btn', function() {
	...
	$('#m_categorie_id').val(data.categorie_id);
...
$('#upBtn').on('click', function() {
    ...
    var data = {
        id: $('#m_id').val(),
        code: $('#m_code').val(),
        categorie_id: $('#m_categorie_id').val(),
        locale: $('#m_locale').val(),
